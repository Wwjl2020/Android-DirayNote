...
public class Update_Text extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText Update_Author;

    private Button Update_Button;

    private Button Update_Return;

    private String context,title,author;
    ...
    public void ShowText() {
        Update_Author.setText(bundle.getString("author"));
    ...
    public void onClick(View view) {
...

        {
            ...
            case R.id.update_text:
                ...
                author=Update_Author.getText().toString();

                Database text_database=new Database(Update_Text.this);

                SQLiteDatabase sqLiteDatabase=text_database.getReadableDatabase();

                boolean flag=text_database.Update(sqLiteDatabase,id,title,context,date,author);
